...
function readyProject(): ProjectDto {
  ...
  return {
    ...
    workflow: {
      ...
      foot_point: null, subject_visibility_audit: null,
      source_perspective_calibration: null, local_ground_anchor: null,
      subject_contact_constraint: null, synthesis_placement: null,
      confirmed_synthesis_placement_revision: null,
      motion_scale: 1, preview_height: 540,
